# CharacterOS historical root README

> Archived during the hackathon repository cleanup. This preserves the former long-form root README, including historical release notes and legacy operating references. Use the current [root README](../../README.md) and [documentation index](../INDEX.md) for active entry points; paths in the historical log may describe the repository as it existed at the time of writing.
...
- [人格动力学科学模型设计](../personality_dynamics_scientific_model_design.md)
